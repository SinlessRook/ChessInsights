...
const LandingPage = (props) => {
  ...
  return (
    <div className='flex flex-col py-10 gap-16 md:flex-row justify-between items-center px-10 min-h-screen overflow-hidden'>
      <div className='flex flex-col gap-4 ml-10'>
        <motion.h1 
        initial={{opacity:0,y:"100vh"}}
        animate={{opacity:1,y:0}}
        transition={{type:'spring',delay:0.4}}
        className='text-white font-bold text-4xl md:text-5xl'>We Try Our Best to</motion.h1>
        <motion.h1 
        initial={{opacity:0,y:"100vh"}}
        animate={{opacity:1,y:0}}
        transition={{type:'spring',delay:0.6}}
        className='text-white font-bold text-4xl md:text-5xl'>Make your Chess Life</motion.h1>
        <motion.h1 
        initial={{opacity:0,y:"100vh"}}
        animate={{opacity:1,y:0}}
        transition={{type:'spring',delay:0.8}}
        className='text-white font-bold text-4xl md:text-5xl'>Simple</motion.h1>
        <br />
        <motion.div
      ...
      className='rounded-3xl mr-10 w-[300px] md:w-[500px]'>
        <img
